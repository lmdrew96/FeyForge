        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Slider value={[partySize]} onValueChange={([v]) => setPartySize(v)} min={1} max={8} step={1} />
            </div>
            <div className="space-y-2">
              <Label>Average Level: {partyLevel}</Label>
              <Slider value={[partyLevel]} onValueChange={([v]) => setPartyLevel(v)} min={1} max={20} step={1} />
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              {monsters.map((monster) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-muted-foreground">({CR_TO_XP[monster.cr]} XP each)</span>
                  </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-foreground">{result.adjustedXP.toLocaleString()} XP</p>
                <p className="text-sm text-muted-foreground">({result.baseXP.toLocaleString()} base XP)</p>
              </div>
            </div>
