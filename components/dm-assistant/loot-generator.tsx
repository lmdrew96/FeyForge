...
const GEMS: Record<number, string[]> = {
  10: [
    ...
    "Moss agate (translucent pink/green)",
    "Obsidian (opaque black)",
    "Rhodochrosite (opaque light pink)",
    "Tiger eye (translucent brown)",
  ...
  50: [
    ...
    "Sardonyx (opaque red/white bands)",
  ...
  100: [
    ...
    "Spinel (transparent red/blue/green)",
    "Tourmaline (transparent pale varied)",
  ],
  500: [
    ...
    "Peridot (transparent rich olive)",
  ...
  1000: [
    ...
    "Opal (translucent pale blue)",
    "Star ruby (translucent ruby asterism)",
    "Star sapphire (translucent blue asterism)",
    "Yellow sapphire (transparent fiery yellow)",
  ],
  5000: [
    "Black sapphire (translucent lustrous black)",
    "Diamond (transparent blue-white)",
    "Jacinth (transparent fiery orange)",
    "Ruby (transparent clear red/deep crimson)",
  ],
}
...
const ART_OBJECTS: Record<number, string[]> = {
  ...
  750: [
    ...
    "Small gold idol",
    "Gold dragon comb with red garnets",
    "Bottle stopper cork with gold leaf",
    "Ceremonial electrum dagger with jet",
  ...
  2500: [
    ...
    "Embroidered silk and velvet mantle",
    "Platinum bracelet with sapphire",
    "Embroidered glove with jewel chips",
    "Jeweled anklet",
    "Gold music box",
    "Gold circlet with four aquamarines",
    "Eye patch with mock eye of sapphire",
    "Necklace of small pink pearls",
  ],
  7500: [
    "Jeweled gold crown",
    "Jeweled platinum ring",
    "Small gold statuette with rubies",
    "Gold cup with emeralds",
    "Gold jewelry box with platinum filigree",
    "Painted gold child's sarcophagus",
    "Jade game board with gold playing pieces",
    "Bejeweled ivory drinking horn",
  ],
}

// Common magic items by rarity
const MAGIC_ITEMS: Record<string, string[]> = {
  common: ["Potion of Healing", "Spell Scroll (cantrip)", "Potion of Climbing", "Driftglobe", "Bag of Holding"],
  uncommon: [
    ...
    <div className="space-y-6">
      <Card className="border-border/50 bg-card/50">
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={generateLoot} className="w-full gap-2">
        ...
        <Card className="border-border/50 bg-card/50">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-start gap-3 rounded-lg border border-border/50 bg-background/50 p-3">
              <Coins className="mt-0.5 h-5 w-5 text-yellow-500" />
              <div>
            ...
            {result.gems && result.gems.length > 0 && (
              <div className="flex items-start gap-3 rounded-lg border border-border/50 bg-background/50 p-3">
                <Gem className="mt-0.5 h-5 w-5 text-cyan-500" />
                  ...
                  <div className="mt-1 space-y-1">
                    {result.gems.map((gem, i) => (
                      <div key={i} className="flex items-center justify-between text-sm">
                        ...
                        <Badge variant="outline">{gem.value} gp</Badge>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="mt-1 space-y-1">
                    {result.artObjects.map((art, i) => (
                      <div key={i} className="flex items-center justify-between text-sm">
                        ...
                        <Badge variant="outline">{art.value} gp</Badge>
                      </div>
                    ))}
                  </div>
                </div>
